...
public class WordCounter {
    ...
    // Yeni overload edilen metod (parametre almayan)
    public static Map<String, Integer> calculatedWord() {
        String defaultText = "When the offensive resumed, the Turks received their first victory " +
                "when the Greeks encountered stiff resistance in the battles of First and Second İnönü, " +
                ...
                "With the conclusion of the Southern and Eastern fronts, Ankara was able to concentrate more forces on the West " +
                "against the Greeks. They also began to receive support from Soviet Union, as well as France and Italy, " +
                "who sought to check British influence in the Near East. " +
                ...
                "their last line of defence. Mustafa Kemal Pasha replaced İsmet Pasha after the defeat as commander in chief as well as his political duties. " +
        ...
        return calculatedWord(defaultText);
    }
}
